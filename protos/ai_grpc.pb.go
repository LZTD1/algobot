...
const (
	...
	Ai_GetInformation_FullMethodName = "/pypkg.Ai/GetInformation"
	Ai_ChangeModel_FullMethodName    = "/pypkg.Ai/ChangeModel"
	Ai_GenerateImage_FullMethodName  = "/pypkg.Ai/GenerateImage"
)
